...
apples1 = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\Apple_Golden_1.dat", delim='\t', normalizenames=true))
apples2 = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\Apple_Golden_2.dat", delim='\t', normalizenames=true))
apples3 = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\Apple_Golden_3.dat", delim='\t', normalizenames=true))
bananas = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\bananas.dat", delim='\t', normalizenames=true))
grapes1 = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\Grape_White.dat", delim='\t', normalizenames=true))
grapes2 = DataFrame(CSV.File("C:\\Users\\tomic\\OneDrive\\Plocha\\BP\\julia\\juliaAcademy\\Courses\\Deep learning with Flux\\data\\Grape_White_2.dat", delim='\t', normalizenames=true))
